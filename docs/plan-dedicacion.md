...
> El plan es realista y comparto lo de evitar la "reunionitis". Para que esas pocas reuniones rindan, propondría apoyarlas en comunicación asíncrona (avances escritos breves antes de cada sync), de modo que el tiempo en vivo se use para desbloquear y decidir, no para reportar. También reservaría de forma explícita una porción de esas 15-20 horas para documentar procesos: si no se protege, es lo primero que se sacrifica bajo presión de entrega y luego se paga como deuda. Y mediría cada tanto las horas reales frente a las planificadas —si el desfase es constante, conviene ajustar el alcance del sprint antes que quemar al equipo—.
