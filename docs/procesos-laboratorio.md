...
Este documento presenta la **organización completa** y los **procesos clave** del laboratorio de computación. Su propósito es estandarizar el funcionamiento, reducir tiempos improductivos, garagarantizar trazabilidad y servir como referencia para la asignatura de **Organización y Métodos**. 
...
> Documento muy completo; la matriz RACI y los KPIs le dan una base sólida. Para que los indicadores no queden en el papel, definiría desde ya su fuente de datos y una línea base: metas como "≤ 48 h de aprobación" o "≥ 70% resueltas automáticamente" solo sirven si el sistema las mide automáticamente y podemos compararlas contra el punto de partida. Sobre la "automatización progresiva" de la sección 6, priorizaría automatizar primero los procesos de mayor volumen (reserva de laboratorio y catálogo de imágenes), donde el ahorro es mayor. También sugeriría añadir el proceso de *Gestión de Incidentes* que se menciona al final: en operación real es el que más impacta el MTTR y hoy no está modelado. E, idealmente, versionaría los BPMN en el repo para que evolucionen junto con la plataforma.
